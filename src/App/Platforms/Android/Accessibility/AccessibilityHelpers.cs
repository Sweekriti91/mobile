...
namespace Bit.Droid.Accessibility
{
    public static class AccessibilityHelpers
    {
        ...
        public static Android.Graphics.Point GetOverlayAnchorPosition(AccessibilityService service, AccessibilityNodeInfo anchorView, 
            int overlayViewHeight, bool isOverlayAboveAnchor)
        {
            var anchorViewRect = new Android.Graphics.Rect();
